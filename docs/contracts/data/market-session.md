---
id: DOC-CONTRACT-DATA-market-session
title: Data Contract — market-session
status: reviewed
version: 0.7
phase: 0
domain: contracts
...
# Data Contract: market-session

## Purpose
Binding schema for **market-session**.
...
## Examples
### Valid
Valid market-session instance satisfying invariants.
