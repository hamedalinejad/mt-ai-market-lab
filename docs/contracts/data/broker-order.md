---
id: DOC-CONTRACT-DATA-broker-order
title: Data Contract — broker-order
status: reviewed
version: 0.7
phase: 0
domain: contracts
...
# Data Contract: broker-order

## Purpose
Binding schema for **broker-order**.
...
## Examples
### Valid
Valid broker-order instance satisfying invariants.
