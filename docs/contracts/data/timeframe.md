---
id: DOC-CONTRACT-DATA-timeframe
title: Data Contract — timeframe
status: reviewed
version: 0.7
phase: 0
domain: contracts
...
# Data Contract: timeframe

## Purpose
Binding schema for **timeframe**.
...
## Examples
### Valid
Valid timeframe instance satisfying invariants.
