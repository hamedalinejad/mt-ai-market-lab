---
id: DOC-CONTRACT-DATA-feature-snapshot
title: Data Contract — feature-snapshot
status: reviewed
version: 0.7
phase: 0
domain: contracts
...
# Data Contract: feature-snapshot

## Purpose
Binding schema for **feature-snapshot**.
...
## Examples
### Valid
Valid feature-snapshot instance satisfying invariants.
